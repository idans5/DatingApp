...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        private readonly IOptions<CloudinarySettings> _cloudinaryConfing;
        private Cloudinary _cloudinary;

        public PhotosController(IDatingRepository repo, IMapper mapper,        
        IOptions<CloudinarySettings> cloudinaryConfing)
        {                   
            _repo = repo;
            _mapper = mapper;
            _cloudinaryConfing = cloudinaryConfing;

            Account acc = new Account(
                _cloudinaryConfing.Value.CloudName,
